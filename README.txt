...
{\*\expandedcolortbl;;}
\margl1440\margr1440\vieww20960\viewh12420\viewkind0
...
\fs36 1. Clone the Linux source.\
2. Modify the make file to compile the quic related files.\
3. Compile and install the linux.\
\

\fs48 Usage:\

\fs36 1. Socket type is IPPROTO_QUIC, and socket opening is normal procedure just like UDP or TCP socket.\
