...
// Kumar: Bringing this static function inside quic.c file as it is needed
// Did not remove static keyword in udp.c and make this function seen here via udp.h as
